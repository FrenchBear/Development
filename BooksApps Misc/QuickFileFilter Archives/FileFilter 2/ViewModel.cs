...
namespace FileFilter
{
    class ViewModel : INotifyPropertyChanged
    {
        ...
        {
            bool invertFlag = false;        // isShiftPressed();
            ...
            else
            {
                ...
                if (RegExp)
                {
                    ...
                    words = ParseQuery(filter);

                // Create a new instance of FilterPredicateBuilder that prepares suitable predicate
                var fpb = new FilterPredicateBuilder(words, AccentSensitive, CaseSensitive, RegExp, WholeWord, invertFlag);
        ...
        public FolderSet SelectedFolderSet
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    model.MemorizeSelectedFolderSet(selectedFolderSet.Root);
                }
            }
        }
        ...
        private bool CanCopyFolderPath(object obj)
        {
            if (window.FilesListView.SelectedItems.Count > 1)
            {
                ...
                if (totalSize < 1024)
                    ...
                    totalSizeString = ((int)((totalSize + 1023) / 1024)).ToString("N0") + " KB";
