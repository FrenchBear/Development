...
**  3/12/94 PV	D‚poussi‚rage, compatibilit‚ rapide avec Dos, fin de near
** 11/04/95 PV	Troncature affichage … 14 caractŠres
*/
...
int fileselect(const char *titre, const char *message, int mode, char *nomfic, char *chemin, char *defaut, char *ext)
{
  int	  lg,ht;
  int	  i,l;
...
static char * joliformat(char *nomfic)
{
...
static void selectparlettre (int lettre)
{
  int i;
