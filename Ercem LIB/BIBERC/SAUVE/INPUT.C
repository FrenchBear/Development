...
void InputMode(iAttActif, iAttRepos)
int iAttActif, iAttRepos;
{
...
int iInput(l0,c0,buf,iLgVar,iLgChamp,szModele)
int	l0,c0,iLgVar,iLgChamp;
UC	*buf,*szModele;
{
  return iWInput(stdscr,l0,c0,buf,iLgVar,iLgChamp,szModele);
}

int iWInput(win,l0,c0,buf,iLgVar,iLgChamp,szModele)
WINDOW *win;
int	l0,c0,iLgVar,iLgChamp;
UC	*buf,*szModele;
{
