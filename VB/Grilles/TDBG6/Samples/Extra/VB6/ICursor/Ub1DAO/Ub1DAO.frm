...
Begin VB.Form Ub1RS 
   Caption         =   "DataMode 1 Recordset Class Sample"
   ClientHeight    =   5490
   ClientLeft      =   1965
   ClientTop       =   1740
   ClientWidth     =   6990
...
Private Sub Command1_Click()
    ...
    DBGrid1.ApproxCount = Sink.RowCount
    DBGrid1.SetFocus
...
Private Sub Form_Resize()
    ...
    If .WindowState <> vbMinimized Then
        ...
        DBGrid1.Height = .ScaleHeight - 1200
