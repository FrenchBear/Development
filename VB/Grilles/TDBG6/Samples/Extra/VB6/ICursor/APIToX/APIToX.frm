...
Private Sub Command1_Click()
    ...
    Dim cs As TrueDBGrid60.Columns
...
Private Sub TDBGrid1_FetchCellTips(ByVal SplitIndex As Integer, ByVal ColIndex As Integer, ByVal RowIndex As Long, CellTip As String, ByVal FullyDisplayed As Boolean, ByVal TipStyle As TrueDBGrid60.StyleDisp)
