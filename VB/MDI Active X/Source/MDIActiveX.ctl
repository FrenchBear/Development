...
Property Let MinSizeX(Wert As Long)
  ...
  If m_inUserMode And Not m_inMDI Then
...
Property Let OptionMove(Wert As Boolean)
  If m_inUserMode And Wert <> m_OptionMove Then
...
Property Let OptionClose(Wert As Boolean)
  If m_inUserMode And Wert <> m_OptionClose Then
    If m_inMDI = False Then
...
Property Get Copyright() As String
    Copyright = "Copyright (c)2000/2001 by Michael Wallner" & vbCrLf & "http://wallner-software.com" & vbCrLf & "mailto:mdiactivex@wallner-software.com"
End Property
