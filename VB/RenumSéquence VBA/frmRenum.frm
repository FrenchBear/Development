...
Begin VB.Form frmRenum 
   ...
   Begin VB.Menu mnuTools 
      Caption         =   "&Tools"
      Begin VB.Menu cmdUserForm1 
         Caption         =   "UserForm1"
      End
      Begin VB.Menu cmdCalcCube 
         Caption         =   "Calcule Cube"
      End
      Begin VB.Menu mnuMacrosMenuItem2 
         ...
         Begin VB.Menu sep1 
            Caption         =   "-"
         End
         Begin VB.Menu cmdOpenVBA 
            Caption         =   "&Open VBA project"
         End
      End
   End
End
...
Private Sub cmdCalcCube_Click()
    Dim r As Double
    r = m_apcInt.ApcProject.Run("myModule", "Cube", 3)
    MsgBox "Result: " & r
End Sub

Private Sub cmdOpenVBA_Click()
    m_apcInt.OpenProj
End Sub

Private Sub cmdUserForm1_Click()
    m_apcInt.ApcProject.Run "myModule", "ShowForm1"
End Sub
