VERSION 5.00
Begin VB.Form frmRayon 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Gestion des codes rayon"
   ClientHeight    =   2295
   ClientLeft      =   150
   ClientTop       =   150
   ClientWidth     =   8415
   ...
   End
End
Attribute VB_Name = "frmRayon"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
' frmRayons
' Feuille de gestion des Rayons
' 12/02/1998 PV
...
' 17/04/2001 PV Gestion du code langue
...
Private cRay As BDCurseur                  ' Curseur courant
...
Private Sub ValidateQuery()
  ...
  Dim cRayQuery As New BDCurseur
  ActiveFormulaire False
  SetMessage "Recherche en cours…"
  Dim iErr As Long, sErr As String, sSQL As String
  On Error Resume Next
  sSQL = "select * from rayon where " & sWP & " order by ray_indice"
  cRayQuery.OpenCurseur sSQL
  iErr = Err
  ...
  If Not cRay Is Nothing Then cRay.CloseCurseur
  Set cRay = cRayQuery
  sFinalSQL = sSQL
  ...
  If Not (cRay.EOF And cRay.BOF) Then
    iMode = meNavigate
    SetMessage
  Else
    iMode = meEmpty
...
Private Sub ValidateAdd()
  ...
  Dim cRayAdd As New BDCurseur
  cRayAdd.OpenCurseur "select * from rayon where ray_indice=0"
  cRayAdd.AddNew
  If Not bPrépareEditAdd(cRayAdd, colColonnes, colChamps) Then cRayAdd.CloseCurseur: Exit Sub
  cRayAdd.CloseCurseur
  
  
  ' Tout est Ok, on sélectionne l'enregistrement qu'on vient d'ajouter
  If Not cRay Is Nothing Then cRay.CloseCurseur
  Set cRay = New BDCurseur
  sFinalSQL = "select * from rayon where ray_indice=" & sFormToSQL(colChamps("ray_indice"), BDTypeINTEGER)
  cRay.OpenCurseur sFinalSQL
  cRay.MoveFirst
  ...
  If iMode = meAdd Then
    ...
    If sMsgTrace <> "" Then
      JournalUnix sTable & " " & colChamps("ray_indice") & " " & colChamps("ray_langue"), "créé", sMsgTrace
    End If
  End If
...
Private Sub ValidateEdit()
  ...
  Assert Not cRay Is Nothing

  If Not bOkNullType(colColonnes, colChamps) Then Exit Sub
  If Not bOkValeurs Then Exit Sub
  cRay.Edit
  If Not bPrépareEditAdd(cRay, colColonnes, colChamps) Then Exit Sub
...
' Tout est Ok: si on est en train de faire une modif, on trace ce qui a été changé
  If iMode = meChange Then
    ...
    Next
    If sMsgTrace <> "" Then
      JournalUnix sTable & " " & colChamps("ray_indice") & " " & colChamps("ray_langue"), "changé", sMsgTrace
    End If
  End If
...
Public Sub ActionChange()
  ...
  ActiveChamp "ray_indice", False
  ActiveChamp "ray_idmodif", False
  ActiveChamp "timestamp", False
  
  colChamps("ray_libelle").SetFocus
  AutoSelect colChamps("ray_libelle"), True
  bdSél.TabStop = False
...
Public Sub ActionDelete()
  ...
  If sMsgTrace <> "" Then
    JournalUnix sTable & " " & colChamps("ray_indice") & " " & colChamps("ray_langue"), "détruit", sMsgTrace
  End If
...
Private Sub AjusteMouvements()
  ...
  bdSél.ButtonEnabled("First") = cRay.AbsolutePosition <> 1
  bdSél.ButtonEnabled("Previous") = cRay.AbsolutePosition <> 1
  bdSél.ButtonEnabled("Next") = Not cRay.EOF
  bdSél.ButtonEnabled("Last") = Not cRay.EOF
End Sub
...
Public Sub ActionNext()
  ...
  cRay.MoveNext
  AjusteMouvements
  If cRay.EOF Then cRay.MoveLast
  SynchroniseFormulaire
End Sub
...
Public Sub ActionPrevious()
  ...
  cRay.MovePrevious
  AjusteMouvements
  If cRay.BOF Then cRay.MoveFirst
  SynchroniseFormulaire
End Sub
    ...
    If Shift = 0 Then
      If iMode = meAdd Or iMode = meChange Or iMode = meQuery Then
        ...
        If Not ActiveControl.Locked Then
          Set C = ActiveControl
          C = colMémoireRayon(ActiveControl.DataField)
          C.Refresh
          SendKeys "{Tab}"
        End If
        KeyCode = 0
...
Private Sub SynchroniseFormulaire()
  If cRay Is Nothing Then
    EffaceFormulaire
  ElseIf cRay.BOF And cRay.EOF Then
    EffaceFormulaire
  Else
    Dim C As Control
    On Error GoTo pb
    For Each C In colChamps
      If IsNull(cRay.Fields(C.DataField)) Then
        C.Text = ""
      Else
        C.Text = cRay.Fields(C.DataField)
      End If
      C.Refresh
    Next
    On Error GoTo 0
    bdSél.NumRec = cRay.AbsolutePosition
  End If
  Exit Sub
...
Public Sub Copie()
  ...
  BDCopieSélection cRay, colChamps, bdSél
...
Public Sub Imprime()
  BDEtat sFinalSQL, drRayon, True
End Sub

Public Sub Aperçu()
  BDEtat sFinalSQL, drRayon, False
End Sub
...
Public Sub Mémorise()
  EffaceCollection colMémoireRayon
  
  Dim t As Control
  For Each t In colChamps
    colMémoireRayon.Add (t), t.DataField
  Next
End Sub
...
Public Sub Historique()
  ...
  Dim sWP As String
  sWP = "jou_domaine='" & sTable & " " & colChamps("ray_indice") & " " & colChamps("ray_langue") & "'"
