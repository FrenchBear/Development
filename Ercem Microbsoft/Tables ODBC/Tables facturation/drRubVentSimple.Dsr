VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drRubVentilation 
   Caption         =   "État Rubriques de ventilation"
   ClientHeight    =   4545
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10530
   Icon            =   "drRubVentSimple.dsx":0000
   MDIChild        =   -1  'True
   _ExtentX        =   18574
   _ExtentY        =   8017
   _Version        =   393216
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Rubriques de ventilation"
      EndProperty
      ItemType1       =   3
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Rubrique de ventilation"
      EndProperty
   EndProperty
   SectionCode2    =   4
   ...
   EndProperty
End
Attribute VB_Name = "drRubVentilation"
