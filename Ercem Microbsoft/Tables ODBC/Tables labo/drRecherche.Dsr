VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drRecherche 
   Caption         =   "État Métaméthodes (Recherches)"
   ClientHeight    =   5220
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11250
   Icon            =   "drRecherche.dsx":0000
   MDIChild        =   -1  'True
   _ExtentX        =   19844
   _ExtentY        =   9208
   _Version        =   393216
   ...
   BottomMargin    =   700
   _Settings       =   31
   Title           =   "État Métaméthodes (Recherches)"
   NumSections     =   5
   SectionCode0    =   1
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Métaméthodes (Recherches)"
      EndProperty
      ItemType1       =   3
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Microb'Soft - Tables labo"
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "drRecherche"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
' drRecherche
' Etat d'impression des métaméthodes
' 15/04/1999 PV

Option Explicit

Dim fMéthode As StdDataFormat

Private Sub DataReport_Initialize()
  Set fMéthode = New StdDataFormat
  fMéthode.Format = "@"
  fMéthode.NullValue = "----- GERMExMÉTHODE INDÉFINI"
  Set Sections("secDétail").Controls("txtLibelléMéthode").DataFormat = fMéthode
End Sub
