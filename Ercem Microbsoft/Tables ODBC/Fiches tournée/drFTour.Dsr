VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drFTour 
   Caption         =   "État Fiches tournée (liste simple)"
   ClientHeight    =   5220
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12120
   Icon            =   "drFTour.dsx":0000
   MDIChild        =   -1  'True
   _ExtentX        =   21378
   _ExtentY        =   9208
   _Version        =   393216
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Microb'Soft - Fiches tournée"
      EndProperty
   EndProperty
   SectionCode1    =   2
