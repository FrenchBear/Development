VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drSecteurActivité 
   Caption         =   "État Secteurs d'activité"
   ClientHeight    =   5220
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8385
   Icon            =   "drSecteurActivité.dsx":0000
   MDIChild        =   -1  'True
   _ExtentX        =   14790
   _ExtentY        =   9208
   _Version        =   393216
   ...
   BottomMargin    =   700
   _Settings       =   31
   Title           =   "État Secteurs d'activité"
   NumSections     =   5
   SectionCode0    =   1
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Secteurs d'activité"
      EndProperty
      ItemType1       =   3
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Microb'Soft - Documents Consultants"
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "drSecteurActivité"
