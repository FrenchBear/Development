   ...
   Begin MSComctlLib.Toolbar tbBoutons 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Key             =   "RefDoc"
            Object.ToolTipText     =   "Gestion des références documentaires"
            Object.Tag             =   "Réf"
            ImageKey        =   "imgRef"
         EndProperty
...
' MDIRefDoc
' Feuille MDI principale de la gestion des références documentaires
' 18/06/1999 NC
'  7/07/1999 PV sSourceODBCDéfaut
' 12/04/2000 PV bLoginForcé à true dans l'appel à ChargementInitialCommun (force le login pour ce programme)
...
Private Sub DétermineModeLectureSeule()
  ...
  bLectureSeule = NZ(colUtilisateur("U" & iNumOpérateur).uti_unite) <> 902
End Sub


Private Sub ChargementInitial(ByVal bDemandeSource As Boolean)
  ChargementInitialCommun Me, bDemandeSource, frmBDODBCLogon.GetSourceODBCDéfaut, True
