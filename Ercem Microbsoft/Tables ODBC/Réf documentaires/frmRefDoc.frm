...
Begin VB.Form frmRefDoc 
   ...
   Begin MSWLess.WLText txtChamp 
      ...
      Appearance      =   1
   End
   Begin MSWLess.WLText txtDactylo 
      Height          =   315
      Left            =   4020
      TabIndex        =   8
      TabStop         =   0   'False
      ...
      Appearance      =   1
   End
   Begin MSWLess.WLText txtAuteur 
      Height          =   315
      Left            =   4020
      TabIndex        =   5
      TabStop         =   0   'False
      ...
      Appearance      =   1
   End
   Begin MSWLess.WLText txtNomDir 
      Height          =   315
      Left            =   4020
      TabIndex        =   2
      TabStop         =   0   'False
   ...
   Begin MSWLess.WLText txtChamp 
      ...
      Appearance      =   1
   End
   Begin MSWLess.WLText txtRefGénérée 
      Height          =   315
      Left            =   3000
      TabIndex        =   18
      TabStop         =   0   'False
    ...
    If Shift = 0 Then
      If iMode = meAdd Or iMode = meChange Or iMode = meQuery Then
        ...
        If Not ActiveControl.Locked Then
          Set c = ActiveControl
          c = colMémoireRefDoc(ActiveControl.DataField)
          c.Refresh
          SendKeys "{Tab}"
        End If
        KeyCode = 0
    ...
    ElseIf Shift = 1 Then
      ...
      For Each c In colChamps
        If Not c.Locked Then      ' On ne remplit pas les champs verrouillés
          c = colMémoireRefDoc(c.DataField)
        End If
      Next
    End If
  Else
...
Private Sub txtChamp_Change(Index As Integer)
  If txtChamp(Index).DataField = "rd_direction" Then ToMaj txtChamp(Index)
  If txtChamp(Index).DataField = "rd_auteur" Then ToMaj txtChamp(Index)
  If txtChamp(Index).DataField = "rd_dactylo" Then ToMin txtChamp(Index)
  If txtChamp(Index).DataField = "rd_ie" Then ToMaj txtChamp(Index)
...
Public Sub Mémorise()
  EffaceCollection colMémoireRefDoc
  
  Dim t As Control
  For Each t In colChamps
    colMémoireRefDoc.Add (t), t.DataField
  Next
End Sub
