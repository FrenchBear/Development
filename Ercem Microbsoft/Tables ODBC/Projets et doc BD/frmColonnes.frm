VERSION 5.00
Begin VB.Form frmDocColonne 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Gestion de la documentation des colonnes"
   ClientHeight    =   2655
   ClientLeft      =   150
   ClientTop       =   150
   ClientWidth     =   8415
   ...
   ScaleWidth      =   561
   Tag             =   "Données"
   Begin Projets.BDCombo bdcLangue 
      Height          =   330
      Left            =   1740
      TabIndex        =   5
      Top             =   1200
   ...
   Begin Projets.BDSélecteur bdSél 
      ...
      EndProperty
   End
   Begin Projets.BDCombo bdcTable 
      Height          =   330
      Left            =   1740
      TabIndex        =   1
      Top             =   480
   ...
   End
End
Attribute VB_Name = "frmDocColonne"
