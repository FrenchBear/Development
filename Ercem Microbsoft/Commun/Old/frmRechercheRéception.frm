...
Begin VB.Form frmRechercheAspectÉchantillon 
   Caption         =   "Recherche d'aspect échantillon"
   ClientHeight    =   3975
   ClientLeft      =   2820
   ClientTop       =   2475
   ClientWidth     =   6615
   Icon            =   "frmRechercheRéception.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRechercheAspectÉchantillon"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Attribute VB_Description = "Feuille de recherche d'un aspect à réception à partir d'une partie de son libellé"
' frmRechercheAspectÉchantillon
' Feuille de recherche d'un aspect à réception à partir d'une partie de son libellé
' 2/9/97 PV
' 29/07/1998 PV Indicateur de tri dans les en-têtes de colonnes
' 25/08/1998 PV ListViewFullRowSelect
' 21/12/1998 PV frmRechercheRéception --> frmRechercheAspectÉchantillon

Option Explicit

Private Sélectionné As Réception
...
Public Function Cherche() As Réception
  Set Sélectionné = Nothing
  Show 1
...
Private Sub btnRechercher_Click()
  ...
  Set Trouvé = RechercheRéception(txtRecherche)
  ...
  Next
  lblStatus = Trouvé.Count & " aspect(s) à réception dont le nom contient " & txtRecherche
