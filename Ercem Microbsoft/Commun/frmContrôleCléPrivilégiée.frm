...
Private Sub btnOK_Click()
  ...
  For i = 1 To Len(txtRéférence.Text)
    t = t + i * Asc(Mid(txtRéférence.Text, i, 1))
  Next
...
Public Sub Internationalisation()
  SetLib Me, "Caption", "OPPCaption"
  
  SetLib btnOK, "Caption", "btnOK"
  SetLib btnAnnuler, "Caption", "btnAnnuler"

  SetLib lblInfo2, "Caption", "OPPInfo2"
  SetLib lblRéférence, "Caption", "OPPlblRef"
  SetLib lblClé, "Caption", "OPPlblClé"
End Sub

Private Sub Form_Load()
  Dim sMsg As String
  sMsg = sGetIntlLib("OPPInfo1", "L'opération en cours (%1) peut présenter des risques et requiert un niveau de privilège spécifique.")
