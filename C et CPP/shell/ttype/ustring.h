...
// PV 29/04/04  Delete, Insert, Replace, Remove
...
*/
	...
	int Insert(int nIndex, wchar_t* pstr);
	int Replace(wchar_t chOld, wchar_t chNew);
	int Replace(wchar_t* lpszOld, wchar_t* lpszNew);
	...
	int FindLast(wchar_t ch) const;                // like "C" strrchr
