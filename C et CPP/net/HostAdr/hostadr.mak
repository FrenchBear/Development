...
!MESSAGE 
!MESSAGE NMAKE /f "hostadr.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/"hostadr.exe" $(OUTDIR)/"hostadr.bsc"
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"hostadr.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"hostadr.bsc" 
BSC32_SBRS= \
	$(INTDIR)/"hostadr.sbr"

$(OUTDIR)/"hostadr.bsc" : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /PDB:$(OUTDIR)/"hostadr.pdb" /MACHINE:I386 /OUT:$(OUTDIR)/"hostadr.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/"hostadr.obj"

$(OUTDIR)/"hostadr.exe" : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"hostadr.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"hostadr.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /PDB:$(OUTDIR)/"hostadr.pdb" /DEBUG /MACHINE:I386 /OUT:$(OUTDIR)/"hostadr.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/"hostadr.obj"
...
$(INTDIR)/"hostadr.obj" :  $(SOURCE)  $(INTDIR)
