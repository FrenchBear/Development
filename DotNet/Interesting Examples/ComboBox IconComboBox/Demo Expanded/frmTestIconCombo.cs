...
namespace IconComboBoxCS
{
	...
	public class frmTestIconCombo : System.Windows.Forms.Form
	{
		...
		private vbAccelerator.Components.Controls.IconComboBox cboIndented;
		private vbAccelerator.Components.Controls.IconComboBox cboColumns;
		...
		private vbAccelerator.Components.Controls.IconComboBox cboDropDownList;
		...
		public frmTestIconCombo()
		{
			...
			// demonstrate how SelectedIndexChanged fires when auto-complete is set
		...
		private void InitializeComponent()
		{
			...
			this.cboIndented = new vbAccelerator.Components.Controls.IconComboBox();
			this.ilsIcons = new System.Windows.Forms.ImageList(this.components);
			this.cboColumns = new vbAccelerator.Components.Controls.IconComboBox();
			...
			this.cboDropDownList = new vbAccelerator.Components.Controls.IconComboBox();
			this.SuspendLayout();
			// 
			// cboIndented
			// 
			this.cboIndented.AutoComplete = true;
			this.cboIndented.BorderStyle = vbAccelerator.Components.Controls.IconComboBox.DrawingStyle.Office10;
			...
			this.cboIndented.HighlightStyle = vbAccelerator.Components.Controls.IconComboBox.DrawingStyle.Office10;
			...
			this.cboColumns.BorderStyle = vbAccelerator.Components.Controls.IconComboBox.DrawingStyle.Office10;
			...
			this.cboColumns.HighlightStyle = vbAccelerator.Components.Controls.IconComboBox.DrawingStyle.Office10;
			...
			this.cboDropDownList.BorderStyle = vbAccelerator.Components.Controls.IconComboBox.DrawingStyle.Office10;
			...
			this.cboDropDownList.HighlightStyle = vbAccelerator.Components.Controls.IconComboBox.DrawingStyle.Office10;
		...
		{
			Console.Write("cboIndented Closed Up");
		}

		private void cboIndented_SelectedIndexChanged(object sender, EventArgs e)
		{
			string text = "No selection";
			if (cboIndented.SelectedItem != null)
			{
				text = cboIndented.SelectedItem.ToString();
			}
			Console.WriteLine("cboIndented Selected item Changed to {0}", text);
		}
	}
}
